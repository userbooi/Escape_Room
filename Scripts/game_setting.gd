...
var levels_layout = [
	...
	},
	{
		...
		"TeVi5":[Vector2(1979, -1999), 0, ["You have reached the end of this game. The goal is to [b]escape[/b] isn't it? However, is there a world [b]outside[/b] of these rooms?", 
										   "[color=#660D0D][i][b]There isn't There isn't There isn't There isn't There isn't[n]There isn't There isn't There isn't There isn't There isn't[n]There isn't There isn't There isn't There isn't There isn't[n]There isn't There isn't There isn't There isn't There isn't[n]There isn't There isn't There isn't There isn't There isn't[/b][/i][/color]", 
										  ...
										  ["Interesting...[br]It seems you weren't a big fan of the cartoon...",
										   "Whether you came searching for another way out after my dialogue in a pervious playthrough or just found it by accident, It matters not",
										   "You found the secret ending.[br]Congratulations.",
										   "As such, I will grant your character forever freedom",
										   "[color=#660D0D][i][b]Forever Forever Forever Forever Forever Forever Forever[n]Forever Forever Forever Forever Forever Forever Forever[n]Forever Forever Forever Forever Forever Forever Forever[n]Forever Forever Forever Forever Forever Forever Forever[n]Forever Forever Forever Forever Forever Forever Forever[n]Forever Forever Forever Forever Forever Forever Forever[n]Forever Forever Forever Forever Forever Forever Forever[n]Forever Forever Forever Forever Forever Forever Forever[/b][/i][/color]",
										   "Bye Bye now."]],
